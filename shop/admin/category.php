...
<?php include('header.php'); ?>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            ...
            <br>
            <a href='cat_add.php' class="btn btn-success">
                ...
                <table class="table table-bordered">
                    ...
                    foreach ($categories as $post) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo substr(escape($post['description']), 0, 125) . '...'; ?>
                            </td>
                            <td>
                                <a href='cat_edit.php?id=<?php echo $post['id']; ?>'
                                   class="btn btn-primary btn-sm mb-1 w-100">
                                    ...
                                    Edit</a>
                                <a href='cat_delete.php?id=<?php echo $post['id']; ?>'
                ...
                <div class='float-right mt-2 mr-5'>
                    <ul class="pagination">
                        <li class="page-item <?php if ($page_no == 1) {
                            ...
                            <a class="page-link" href="?page_no=<?php if ($page_no <= 1) {
                                echo $page_no;
                            } else {
                                echo $page_no - 1;
                            } ?>" aria-label="Previous">
                        ...
                        <li class="page-item <?php if ($page_no == $total_page) {
                            echo 'disabled';
                        } ?>"><a class="page-link" href="?page_no=<?php if ($page_no < $total_page) {
                                echo $page_no + 1;
                            } else {
                                echo $page_no;
                            } ?>">Next Page</a>
