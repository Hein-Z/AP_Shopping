                                ...
                                if ($result) {
                                    ...
                                    foreach ($result as $value) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="product_img/<?php echo $pResult[0]['image'] ?>" width="100" alt=""></td>
                            ...
                            <nav aria-label="Page navigation example" style="float:right">
                                <ul class="pagination">
                                    <li class="page-item"><a class="page-link"
                                                             href="?id=<?php echo $_GET['id'] ?>&pageno=1">First</a>
                                    </li>
                                    ...
                                    <li class="page-item"><a class="page-link"
                                                             href="?id=<?php echo $_GET['id'] ?>&pageno=<?php echo $total_pages ?>">Last</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
