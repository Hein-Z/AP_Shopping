    ...
    <div class="container">
        <div class="cart_inner">
            <div class="table-responsive">
                        ...
                        foreach ($_SESSION['cart'] as $key => $qty) {
                            ...
                            <tr>
                                <td>
                                    <div class="media">
                                        <div class="d-flex">
                                            <img src="admin/product_img/<?php echo escape($result['image'])?>" width="100" height="110">
                                        </div>
                        ...
                        <tr class="out_button_area">
                            ...
                            <td>
                                <div class="checkout_btn_inner d-flex align-items-center">
                                    <a class="btn gray_btn" href="clearall.php">Clear All</a>
                                    <a class="btn primary-btn" href="index.php">Continue Shopping</a>
                                    <a class="btn gray_btn" href="sale_order.php">Order Submit</a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
                ...
                <?php }else{?>
                <div>
                    <h3 class="text-success">There is nothing in your cart.</h3>
                    <a class="btn primary-btn" href="index.php">Continue Shopping</a>
                </div>
                <?php }?>
            </div>
