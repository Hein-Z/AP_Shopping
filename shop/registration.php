    ...
    <div class="main_menu">
        <nav class="navbar navbar-expand-lg navbar-light main_box border border-warning ">
            <div class="container">
                ...
                <a class="navbar-brand logo_h" href="index.html">AP Shop</a>
            </div>
        </nav>
    </div>
...
<!--================Login Box Area =================-->
<section class="login_box_area section_gap pb-0">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                <div class="login_form_inner">
                    ...
                    <form class="row login_form" action="registration.php" method="post"
                        ...
                        <div class="col-md-12 form-group">
                            <input type="password" class="form-control" id="name" name="confirm_password" placeholder="Password"
                                   onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'">
                        </div>
                        <div class="col-md-12 form-group">
